package com.jcs.where.features.enterprise.adapter
 ...
 * 企业黄页三级分类
 */
class EnterpriseThirdCategoryAdapter : BaseQuickAdapter<Category, BaseViewHolder>(R.layout.item_enterprise_third_category) {
