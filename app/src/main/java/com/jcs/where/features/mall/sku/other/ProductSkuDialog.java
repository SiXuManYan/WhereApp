...
public class ProductSkuDialog extends Dialog {
    ...
    private void initView() {
        ...
        binding.scrollSkuList.setListener(new OnSkuListener() {
            ...
            public void onUnselected(SkuAttribute unselectedAttribute) {
                selectedSku = null;
                GImageLoader.displayUrl(context, binding.ivSkuLogo, product.getMain_image());
                binding.tvSkuQuantity.setText(String.format(stockQuantityFormat, product.getStock()));
    ...
    private void updateSkuData() {
        ...
        if (firstSku.getStockQuantity() > 0) {
            ...
            GImageLoader.displayUrl(context, binding.ivSkuLogo, product.getMain_image());
            binding.tvSkuSellingPrice.setText(String.format(priceFormat, NumberUtils.formatNumber(product.getPrice() / 100)));
            binding.tvSkuSellingPriceUnit.setText("/" + product.getMeasurementUnit());
            binding.tvSkuQuantity.setText(String.format(stockQuantityFormat, product.getStock()));
            binding.btnSubmit.setEnabled(false);
