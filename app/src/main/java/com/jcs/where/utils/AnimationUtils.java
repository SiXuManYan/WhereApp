...
public class AnimationUtils {
     ...
     * 0 ~ 180
     */
    public static RotateAnimation getRotateAnimationByCenter180(Animation.AnimationListener animationListener) {
        return getRotateAnimation(0f, 179f, Animation.RELATIVE_TO_SELF, 0.5f,
                Animation.RELATIVE_TO_SELF, 0.5f, DEFAULT_ANIMATION_DURATION,
                animationListener);
    }
     ...
     * 180 ~ 360
     */
    public static RotateAnimation getRotateAnimationByCenter360(Animation.AnimationListener animationListener) {
        return getRotateAnimation(180f, 360f, Animation.RELATIVE_TO_SELF, 0.5f,
                Animation.RELATIVE_TO_SELF, 0.5f, DEFAULT_ANIMATION_DURATION,
                animationListener);
    }
