...
/**
 * Created by Wangsw  2021/3/18 15:19.
 *
 * @see <a href="https://github.com/Stars-One/CirclePointMove">CirclePoint</a>
 */
public class CirclePoint extends LinearLayout {
    ...
    private void handlePictureOn() {
        selected_point = (GradientDrawable) ResourceUtils.getDrawable(R.drawable.shape_point_selected);
        unselected_point = (GradientDrawable) ResourceUtils.getDrawable(R.drawable.shape_point_normal);
    }
