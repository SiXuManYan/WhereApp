package com.jiechengsheng.city.widget.comment;
...
public class StarView extends View {
    ...
    public StarView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CommentView, defStyleAttr, 0);
        mStarCount = typedArray.getInt(R.styleable.CommentView_starCount, 5);
        mCheckStarCount = typedArray.getInt(R.styleable.CommentView_checkStarCount, 0);
        mCheckStarDrawable = typedArray.getResourceId(R.styleable.CommentView_checkStarCount, R.mipmap.ic_comment_star_yellow);
        mStarDrawable = typedArray.getResourceId(R.styleable.CommentView_checkStarCount, R.mipmap.ic_comment_star_gray);
        mStarWidth = typedArray.getDimensionPixelSize(R.styleable.CommentView_starWidth, 20);
        mStarHeight = typedArray.getDimensionPixelSize(R.styleable.CommentView_starHeight, 20);
        mStarHorizontalSpace = typedArray.getDimensionPixelSize(R.styleable.CommentView_starHorizontalSpace, 20);
        typedArray.recycle();
